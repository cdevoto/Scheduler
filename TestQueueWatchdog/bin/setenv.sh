#
# Test Queue Watchdog Environment
#

echo Setting the Test Queue Watchdog environment..
...
LOG_DIR=/dfs1/ruxit/scheduler/watchdog
...
export SCHEDULER_OPTS="-Dcompuware.application.home=$SCHEDULER_HOME -Dcompuware.application.engine=com.compuware.ruxit.synthetic.scheduler.watchdog.engine.WatchdogEngine -Duser.timezone=GMT -Dlog.extra.appenders=,daily_rolling -Dlog.dir=$SCHEDULER_LOG"
