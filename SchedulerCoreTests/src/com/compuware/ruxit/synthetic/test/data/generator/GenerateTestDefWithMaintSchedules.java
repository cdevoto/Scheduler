...
public class GenerateTestDefWithMaintSchedules {
	...
	public static void main(String[] args) {
		...
		builder = UITestDefinitionForm.create();
		builder.withName("Test Definition Odd")
		       .withScriptId(1)  // Check on what sorts of limitations the script has and confirm that the Lcps
		       .withTenantId(1)
		       .withRequiresFlag("IPv4")
               .withExecutionSchedule("*/5 * * * *")
               ...
               .withLcp(46)
               .withLcp(51);
		testDef = builder.build();
		service.createTestDefinition(testDef);

		builder = UITestDefinitionForm.create();
		builder.withName("Test Definition Y")
		       .withScriptId(1)  // Check on what sorts of limitations the script has and confirm that the Lcps
		       .withTenantId(1)
		       .withRequiresFlag("IPv4")
               .withExecutionSchedule("*/5 * * * *")
               ...
               .withLcp(51);
		testDef = builder.build();
		long id2 = service.createTestDefinition(testDef);

		System.out.printf("Generated a test definition with id %d.%n", id2);

		UIScheduleForm schedule = UIScheduleForm.create()
				.withTenantId(1)
				.withTimezoneId(7)
				.withName("Custom Maintenance Schedule 1")
				.withRecurrenceRule("0 22 * * *")
				.withDuration(60)
				.withTestDefinition(id2)
		...
		schedule = UIScheduleForm.create()
				.withTenantId(1)
				.withTimezoneId(7)
				.withName("Custom Maintenance Schedule 2")
				.withRecurrenceRule("0 22 * * *")
				.withDuration(60)
				.withTestDefinition(id1)
				.withMaintenance(true)
				.build();
		long id4 = service.createSchedule(schedule);

		System.out.printf("Generated a schedule with id %d.%n", id4);
